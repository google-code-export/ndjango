...
module Interfaces = 
    ...
    type ITemplateManager = 
        ...
        abstract member RenderTemplate: string * IDictionary<string, obj> * System.Action<ITemplateManager> -> TextReader
    ...
    and ITemplate =
        ...
        abstract Walk: IDictionary<string, obj> -> (ITemplateManager -> unit) -> System.IO.TextReader
    ...
    and IContext =
        ...
        abstract member GetTemplate: string -> IContext * ITemplate
