...
namespace NDjango.UnitTests
{
    public partial class Tests
    {
        ...
        public IList<TestDescriptor> GetBasicTests()
        {
            ...
            lst.Add(new TestDescriptor("basic-syntax12", "{{ var.__dict__ }}", ContextObjects.p("var", new ContextObjects.SomeClass()), ContextObjects.p(typeof(Lexer.SyntaxException))));

            // Raise TemplateSyntaxError when trying to access a variable containing an illegal character
            lst.Add(new TestDescriptor("basic-syntax13", "{{ va>r }}", ContextObjects.empty, ContextObjects.p(typeof(Lexer.SyntaxException))));
            lst.Add(new TestDescriptor("basic-syntax14", "{{ (var.r) }}", ContextObjects.empty, ContextObjects.p(typeof(Lexer.SyntaxException))));
            lst.Add(new TestDescriptor("basic-syntax15", "{{ sp%am }}", ContextObjects.empty, ContextObjects.p(typeof(Lexer.SyntaxException))));
            lst.Add(new TestDescriptor("basic-syntax16", "{{ eggs! }}", ContextObjects.empty, ContextObjects.p(typeof(Lexer.SyntaxException))));
            lst.Add(new TestDescriptor("basic-syntax17", "{{ moo? }}", ContextObjects.empty, ContextObjects.p(typeof(Lexer.SyntaxException))));
            ...
            lst.Add(new TestDescriptor("basic-syntax23", "{{ moo //} {{ cow }}", ContextObjects.p("cow", "cow"), ContextObjects.p(typeof(Lexer.SyntaxException))));
