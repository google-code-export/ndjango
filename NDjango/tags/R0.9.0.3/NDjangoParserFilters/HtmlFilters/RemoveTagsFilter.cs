...
namespace NDjango.FiltersCS
{
    ...
    public class RemoveTagsFilter : NDjango.Interfaces.IFilter
    {
        ...
        {
            string[] tags = Convert.ToString(__p2, FilterManager.Inv).Split((string[])null, StringSplitOptions.RemoveEmptyEntries);
            ...
            string retValue = regxStartTag.Replace(Convert.ToString(__p1, FilterManager.Inv), string.Empty);
