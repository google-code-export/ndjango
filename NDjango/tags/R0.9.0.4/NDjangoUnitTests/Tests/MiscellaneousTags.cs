...
//            lst.Add(new TestDescriptor("date filter 02", "{{ now|date:\"D,d F Y G:i:\\s O\" }}", ContextObjects.p("now", null), ContextObjects.p(DateTime.Now.ToString("ddd,dd MMMM yyyy %H:mm:\\s zzz"))));
