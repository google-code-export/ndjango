...
namespace NDjango.FiltersCS
{
    ...
    public class SliceFilter: NDjango.Interfaces.IFilter
    {
        ...
        {
            string[] sliceParams = Convert.ToString(__p2, FilterManager.Inv).Split(new String[] {":"},StringSplitOptions.None);

            object toConvert = (__p1 is IEnumerable) ? __p1 : Convert.ToString(__p1, FilterManager.Inv);
